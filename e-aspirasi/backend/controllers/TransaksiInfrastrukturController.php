...
use common\models\TransaksiInfrastrukturSearch;
...
class TransaksiInfrastrukturController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TransaksiInfrastruktur #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TransaksiInfrastruktur",
                ...
                return [
                    ...
                    'title'=> "Create new TransaksiInfrastruktur",
                    'content'=>'<span class="text-success">Create TransaksiInfrastruktur success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_infrastruktur]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TransaksiInfrastruktur #".$id,
    ...
    /**
     * Delete an existing TransaksiInfrastruktur model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TransaksiInfrastruktur model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
