...
use common\models\TransaksiPelayananSearch;
...
class TransaksiPelayananController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TransaksiPelayanan",
                ...
                return [
                    ...
                    'title'=> "Create new TransaksiPelayanan",
                    'content'=>'<span class="text-success">Create TransaksiPelayanan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_pelayanan]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TransaksiPelayanan #".$id,
    ...
    /**
     * Delete an existing TransaksiPelayanan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TransaksiPelayanan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
