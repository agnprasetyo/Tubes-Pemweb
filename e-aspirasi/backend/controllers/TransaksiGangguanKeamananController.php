...
use common\models\TransaksiGangguanKeamananSearch;
...
class TransaksiGangguanKeamananController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "TransaksiGangguanKeamanan #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new TransaksiGangguanKeamanan",
                ...
                return [
                    ...
                    'title'=> "Create new TransaksiGangguanKeamanan",
                    'content'=>'<span class="text-success">Create TransaksiGangguanKeamanan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_gangguan]);
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update TransaksiGangguanKeamanan #".$id,
    ...
    /**
     * Delete an existing TransaksiGangguanKeamanan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TransaksiGangguanKeamanan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
